...
def __getattr__(name: str) -> LibraryFunction:
    """Dynamically create a LibraryFunction for unknown ASH function names. This ensures support for ASH functions added in KoLmafia revisions newer than what the package was released with."""
